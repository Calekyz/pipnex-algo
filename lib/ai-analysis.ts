...
// ============================================
// 1. Main Analysis (Gemini + fallback)
// ============================================
export async function generateForexAnalysis(
  ...
  try {
    ...
    // Build prompt with safe fallback for null indicators
    const prompt = `
    ...
    try {
      ...
      return {
        ...
        take_profit: 'N/A',
        confidence: 50,
        rationale: 'Analysis could not be parsed. Please try again.',
      };
    }
  } catch (error) {
    ...
    return {
      ...
      take_profit: 'N/A',
      confidence: 50,
      rationale: 'AI service temporarily unavailable. Please try again later.',
    };
  }
}
...
export async function generatePulseSignal(
  ...
  try {
    ...
    console.error('Pulse signal error:', error);
    return {
      direction: 'BUY',
      entry_price: 'N/A',
      stop_loss: 'N/A',
      ...
      pips: 0,
      confidence: 50,
      rationale: 'Signal generation temporarily unavailable.',
    };
  }
}

// ============================================
// 3. Batch Pulse Signals
// ============================================
